...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        # для второго окна с поиском

        self.add_img1 = tk.PhotoImage(file="sea.gif")
        btn_open_dialog1 = tk.Button(toolbar, text='Поиск', command=self.open_search, bg='#5da130', bd=0,
...
class Search(tk.Toplevel):
    ...
    def init_seach(self):
        ...
        btn_cancel = ttk.Button(self, text='Закрыть', command=self.destroy)
        btn_cancel.place(x=110, y=50)

        self.btn_ok = ttk.Button(self, text='Поиск')
        self.btn_ok.place(x=200, y=50)
